...
class SelectVehicleViewController: VehicleListViewController {
    ...
    var vehicleChanged : ((Vehicle) -> Void)!
    ...
    override func didSelectVehicle(_ vehicle: Vehicle) {
        ...
        if self.appointment == nil {
            ...
            let refreshAlert = UIAlertController(
                title: "Are you sure?",
                message: "Are you sure you wish to create this appointment?",
            ...
            self.appointmentEdit.vehicle = vehicle
            ...
            self.vehicleChanged(self.appointmentEdit.vehicle)
